...
$attribut = '';
//form open
echo form_open(base_url('index.php/admin/kependudukan/tambah'),$attribut);
?>
...
<div class="col-md-12">
    <div class="form-group">
        ...
        <input type="date" id="tglLapor" class="form-control" name="tanggal_lapor" required>
    </div>
	...
	<div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="no_kk_sebelum" class="form-control" placeholder="Nomor KK Sebelumnya" value="<?= set_value('no_kk_sebelum') ?>">
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="number" name="akta_kelahiran" class="form-control" placeholder="Nomor Akta Kelahiran" value="<?= set_value('akta_kelahiran') ?>">
            </div>
        </div>
        <div class="col-md-8">
            <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="time" id="waktu_kelahiran" class="form-control" name="waktu_kelahiran" required>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="number" id="berat_lahir" class="form-control" name="berat_lahir" placeholder="Berat Lahir">
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <label for="panjang_lahir" class="form-control-label">Panjang Lahir (cm)</label>
                <input type="number" id="panjang_lahir" class="form-control" name="panjang_lahir" placeholder="Panjang Lahir">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="pekerjaan" class="form-control" placeholder="Pekerjaan" value="<?= set_value('pekerjaan') ?>" required>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" name="suku" class="form-control" placeholder="Suku/Etnis" value="<?= set_value('suku') ?>">
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="number" id="nomor_paspor" class="form-control" name="nomor_paspor" placeholder="Nomor Paspor">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label for="tgl_berakhir_paspor" class="form-control-label">Tanggal Berakhir Paspor</label>
                <input type="date" id="tgl_berakhir_paspor" class="form-control" name="tgl_berakhir_paspor">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="number" id="nik_ayah" class="form-control" name="nik_ayah" placeholder="Nomor NIK Ayah">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="number" id="nik_ibu" class="form-control" name="nik_ibu" placeholder="Nomor NIK Ibu">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" id="dusun" class="form-control" name="dusun" required>
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                <label for="rw" class="form-control-label">RW</label>
                <input type="number" id="rw" class="form-control" name="rw" required>
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                <label for="rt" class="form-control-label">RT</label>
                <input type="number" id="rt" class="form-control" name="rt" required>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" id="alamat_sebelumnya" class="form-control" name="alamat_sebelumnya">
    </div>
    
    <div class="form-group">
        <label for="alamat_sekarang" class="form-control-label">Alamat Sekarang</label>
        <input type="text" id="alamat_sekarang" class="form-control" name="alamat_sekarang">
    </div>
...
<script>
    document.getElementById('tglLapor').valueAsDate = new Date();
</script>
<?php
//Form close
echo form_close();
