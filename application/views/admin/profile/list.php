<div class="row mb-5">
            ...
            <ul class="nav flex-column bg-white border-radius-lg p-3">
                ...
                <li class="nav-item pt-2">
                    <a class="nav-link text-body" data-scroll="" href="#basic-info">
                        ...
                        <span class="text-sm">Biodata</span>
                    </a>
                </li>
                <li class="nav-item pt-2">
    ...
    <div class="col-lg-9 mt-lg-0 mt-4">
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-sm-auto col-4">
                    <div class="avatar avatar-xl position-relative">
                        <img src="<?= base_url('assets/img/bruce-mars.jpg') ?>" alt="bruce"
            ...
            <div class="card-body pt-0">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="input-group">
                            <input id="email" value="<?=$user->email ?>" name="email" class="form-control" type="email"
                                placeholder="contoh@email.com">
                        </div>
                    </div>
                    <!-- <div class="col-6">
                        <label class="form-label mt-4">Konfirmasi Email</label>
                        <div class="input-group">
                            <input id="confirmation" name="email_konfirm" class="form-control" type="email"
                                placeholder="contoh@email.com">
                        </div>
                    </div> -->
                    <div class="col-6">
                        <label class="form-label mt-4">No Telp</label>
                        <div class="input-group">
                            <input id="phone" name="no_telp" value="<?= $user->no_telp ?>" class="form-control"
                                type="number" placeholder="089xxxxxxx">
                        </div>
                    </div>
                </div>
                <div class="row mt-5">
                    <div class="col-lg-8 col-12 actions text-end ms-auto">
                        <button class="btn bg-gradient-success btn-sm mb-0" type="submit">Ubah</button>
                    </div>
                </div>
                <?= form_close() ?>
            </div>
        ...
        <div class="card mt-4" id="password">
            ...
            <div class="card-body pt-0">
                <?php if($this->session->flashdata('sukses_pw')){ ?>
                <div class="alert alert-success text-white alert-dismissible fade show" role="alert">
                    <span class="alert-icon"><i class="ni ni-like-2"></i></span>
                    <span class="alert-text"><strong>Sukses!</strong>
                        <?= $this->session->flashdata('sukses_pw') ?></span>
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                ...
                <div class="alert alert-danger text-white alert-dismissible fade show" role="alert">
                    ...
                    <span class="alert-text"><strong>Gagal!</strong>
                        <?= $this->session->flashdata('gagal') ?></span>
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                ...
                <ul class="text-muted ps-4 mb-0 float-start">
                    <li>
                        <span class="text-sm">Satu spesial karakter</span>
                    </li>
                    <li>
                        <span class="text-sm">Min 6 karakter</span>
                    </li>
                    <li>
                        <span class="text-sm">Satu angka atau (2 direkomendasikan)</span>
                    </li>
                    <li>
                        <span class="text-sm">Rubah password berkala</span>
                    </li>
                </ul>
        ...
        <div class="card mt-4" id="delete">
            ...
            <div class="card-body d-sm-flex pt-0">
                <div class="d-flex align-items-center mb-sm-0 mb-4">
                    ...
                    <div class="ms-2">
                        <span class="text-dark font-weight-bold d-block text-sm">Konfirmasi</span>
                        <span class="text-xs d-block">Saya ingin menghapus akun saya.</span>
                    </div>
                </div>
                <button class="btn btn-outline-secondary mb-0 ms-auto" type="button" name="button">Nonaktifkan</button>
