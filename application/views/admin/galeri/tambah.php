...
//form open
echo form_open_multipart(base_url('index.php/admin/galeri/tambah'),$attribut);
?>
...
<div class="col-md-6">
	<div class="form-group">
		...
		<input type="url" name="website" class="form-control" placeholder="<?= site_url() ?>" value="<?= set_value('website') ?>">
	</div>
</div>
