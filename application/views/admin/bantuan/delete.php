<div class="modal fade" id="hapus<?= $bantuan->id ?>" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="py-3 text-center">
                    ...
                    <p>Hapus Bantuan Ini? Data Tidak Bisa Dikembalikan!</p>
                </div>
            </div>
            <div class="modal-footer">
                <a href="<?= base_url('admin/bantuan/delete/'.$bantuan->id) ?>"
