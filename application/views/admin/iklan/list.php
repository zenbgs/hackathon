    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0">
                ...
                <?php } ?>
                <h6 style="float:left !important">Tabel Iklan</h6>
                <a href="<?= base_url('admin/iklan/tambah') ?>"
                    ...
                    <span class="btn-inner--text">Tambah Iklan</span>
                </a>
            </div>
                        ...
                        ?>
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <span class="mb-0 text-sm"><?= $iklan->judul ?></span>
                                            <p class="text-xs text-secondary mb-0"><?= $iklan->isi_konten ?></p>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td class="align-middle text-sm">
                                    <?php
                                if($iklan->status == 'Publish'){
                                ?>
                                    <span
                                        class="badge badge-sm bg-gradient-success"><?= $iklan->status ?></span>
                                    <?php }else{ ?>
                                    <span
                                        class="badge badge-sm bg-gradient-warning"><?= $iklan->status ?></span>
                                    <?php } ?>
                                </td>
                                <td class="align-middle text-center text-sm">
                                    <a href="<?= base_url('admin/iklan/edit/'.$iklan->id) ?>"
                                    ...
                                    <a href="javascript:;" class="text-gradient text-danger font-weight-bold text-xs"
                                        title="Hapus Iklan" data-bs-toggle="modal" data-bs-target="#hapus<?= $iklan->id ?>">
                                        Hapus
                                    </a>
