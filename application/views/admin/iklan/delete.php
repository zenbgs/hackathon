<div class="modal fade" id="hapus<?= $iklan->id ?>" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="py-3 text-center">
                    ...
                    <p>Hapus Iklan Ini? Data Tidak Bisa Dikembalikan!</p>
                </div>
            </div>
            <div class="modal-footer">
                <a href="<?= base_url('admin/iklan/delete/'.$iklan->id) ?>"
